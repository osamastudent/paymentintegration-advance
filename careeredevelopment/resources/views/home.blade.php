            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('single.charge')}}" method="POST" id="subscribe-form">
                        ...
                        <input id="amount" name="amount" type="number" class="form-control mt-1">
                        ...
                        <div class="form-group  mt-3">
                            <button id="card-button" data-secret="{{ $intent->client_secret }}" class="btn  btn-success btn-block">Pay</button>
                        </div>
                    </form>
